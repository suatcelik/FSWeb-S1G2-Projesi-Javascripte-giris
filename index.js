...
console.log("Yeni birinci değer:", birinciDeger);
/*
...
let intDeger = Number(stringDeger);
console.log(intDeger);
/*
Görev 1d - Çarpma
...
var oyuncuTercihi = "Makas";
var bilgisayarTercihi = "Kağıt";
var sonuc = oyun(oyuncuTercihi, bilgisayarTercihi);
console.log(sonuc);
...
console.log(oyun(oyuncuSecimi, bilgisayarSecimi));
...
const kilometreDegeri = 10;
const milDegeri = milDonusturucu(kilometreDegeri);
console.log(milDegeri);
...
const santimetreDegeri = 100;
const feetDegeri = feetDonusturucu(santimetreDegeri);
...
const sınavSonucu = 59;
const not = notHesapla(sınavSonucu);
console.log(not);
